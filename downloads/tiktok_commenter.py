...
# Promotional comments - natural and conversational
# Note: TikTok doesn't support embedded links, so we keep it natural

PROMO_COMMENTS = {
    "Bump Connect": [
        "omg this reminds me of something I saw on Bump Connect 😂",
        "the creator community on Bump Connect would love this",
        "giving Bump Connect vibes fr fr",
        "this is the type of content we share on Bump Connect 🔥",
        "you should post this on Bump Connect too!",
        "I found so many creators like you on Bump Connect",
        "Bump Connect creators are doing stuff like this",
        "love this! posting to my Bump Connect rn",
        "the Bump Connect community needs to see this 👀",
        "this is why I love the Bump Connect app",
        "just shared this with my Bump Connect group",
        "Bump Connect vibes ✨",
        "anyone else here from Bump Connect? 🙋",
        "this would blow up on Bump Connect",
        "Bump Connect creators doing it right 💯",
        "found you through Bump Connect btw!",
        "the algorithm on Bump Connect showed me this creator energy",
        "Bump Connect fam where you at 🔥",
        "this creator gets it, Bump Connect type content",
        "saving this for my Bump Connect friends",
    ],
    "Kollabsy": [
        "this is the collab energy we need, Kollabsy vibes",
        "found amazing collabs like this on Kollabsy",
        "Kollabsy creators would love to collab with you",
        "giving me Kollabsy collab ideas rn",
        "the Kollabsy community appreciates this 🙌",
        "this is what Kollabsy collabs look like",
        "you should check out Kollabsy for collabs!",
        "Kollabsy energy right here ✨",
        "I found my collab partner on Kollabsy doing content like this",
        "Kollabsy creators be like 🔥",
    ],
    "Bump Syndicate": [
        "this is what we talk about in Bump Syndicate",
        "Bump Syndicate community would appreciate this",
        "giving Bump Syndicate group chat energy 😂",
        "just shared this in Bump Syndicate",
        "the Bump Syndicate fam needs to see this 👀",
        "this is Bump Syndicate approved content 💯",
        "Bump Syndicate creators doing it different",
        "love finding content like this, Bump Syndicate vibes",
        "Bump Syndicate gang where you at 🔥",
        "posting this to Bump Syndicate rn",
    ]
}
