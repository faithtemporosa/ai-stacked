...
APP_LINK = "apps.apple.com/app/bump-connect/id6475402930"
APP_LINK_FULL = "https://apps.apple.com/us/app/bump-connect-social-community/id6475402930"

PROMO_COMMENTS = {
    "Bump Connect": [
        f"Have you checked out Bump Connect? Download here: {APP_LINK} 🔥",
        f"Bump Connect is amazing for creators! Get it: {APP_LINK}",
        f"If you're looking to grow, get Bump Connect: {APP_LINK} 👀",
        f"Bump Connect helped me so much! {APP_LINK}",
        f"You should try Bump Connect! Free download: {APP_LINK} 🤝",
        f"Check out Bump Connect for creator growth: {APP_LINK}",
        f"Bump Connect changed my creator journey! {APP_LINK}",
        f"Game changer for creators: {APP_LINK} 💯",
        f"Download Bump Connect: {APP_LINK} 🙌",
        f"Best app for creators: {APP_LINK} 🚀",
        "Have you tried Bump Connect? Search it on the App Store!",
        "Bump Connect is free on the App Store, check it out!",
        "Every creator needs Bump Connect, find it on App Store 📱",
        "Bump Connect on App Store = more growth 🔥",
        "Search Bump Connect on App Store, thank me later!",
    ],
    "Kollabsy": [
        f"Have you tried Kollabsy? Get Bump Connect: {APP_LINK} 🎬",
        f"Kollabsy feature on Bump Connect is amazing! {APP_LINK}",
        f"Find collabs easy with Bump Connect: {APP_LINK} 🤝",
        f"Kollabsy + Bump Connect = perfect collabs! {APP_LINK}",
        f"Download Bump Connect for collabs: {APP_LINK} 💯",
        "Kollabsy is the best for finding collabs!",
        "Check out Kollabsy on the App Store!",
        "Finding collabs made easy with Kollabsy 🎬",
        "Kollabsy connected me with amazing creators!",
        "Every creator needs Kollabsy for collabs 🤝",
    ],
    "Bump Syndicate": [
        f"Join Bump Syndicate! Download: {APP_LINK} 🔥",
        f"Bump Syndicate community is amazing! {APP_LINK}",
        f"Best creator community - Bump Syndicate: {APP_LINK} 🙌",
        f"Grow with Bump Syndicate: {APP_LINK}",
        f"Download Bump Connect for Syndicate: {APP_LINK} 💯",
        "Bump Syndicate is the best creator community!",
        "Have you joined Bump Syndicate yet? App Store! 🔥",
        "Bump Syndicate = real growth, search App Store!",
        "Join Bump Syndicate, best decision ever!",
        "Bump Syndicate community is fire 🔥",
    ]
}
